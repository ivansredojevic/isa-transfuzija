...
-- admin
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'ivan.m.sredojevic@gmail.com', 'admin', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'admin pass user', 'adminovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'medical center admin', 'admin at medical centers', true, 'ROLE_ADMIN', '99a3a2fb-cc06-46e3-9086-2c76aa323804', 0);
-- user

insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'ivan.sredojevic@devoteam.com', 'user', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'Ivan', 'Sredojevic', 'bul c laz 21', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'it consultant', 'senior consultant at dt srb', true, 'ROLE_USER', '99a3a2fb-cc06-46e3-9086-2c76aa323801', 0);
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'ivansoko93@gmail.com', 'user12', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'user12 pass user', 'userovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'it consultant', 'junior consultant at dt srb', true, 'ROLE_USER', '99a3a2fb-cc06-46e3-9086-2c76aa323802', 2);
