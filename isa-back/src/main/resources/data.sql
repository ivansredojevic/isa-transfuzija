...
-- admin
insert into application_user (dtype, email, username, password, name, surname, address, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'ivan.m.sredojevic@gmail.com', 'admin', '$2a$10$3TnwcRM8Es3lm3jQUClvK.wugatrVpe209UJ5xaKbec3EMAoaClve', 'admin pass user', 'adminovic', 'bul c laz 22', '0640276707', '1012993773648', 'm', 'medical center admin', 'admin at medical centers', true, 'ADMIN', '99a3a2fb-cc06-46e3-9086-2c76aa323804', 0);
-- user
insert into application_user (dtype, email, username, password, name, surname, address, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'ivan.sredojevic@devoteam.com', 'user', '$2a$10$3TnwcRM8Es3lm3jQUClvK.wugatrVpe209UJ5xaKbec3EMAoaClve', 'Ivan', 'Sredojevic', 'bul c laz 21', '0640276707', '1012993773648', 'm', 'it consultant', 'senior consultant at dt srb', true, 'USER', '99a3a2fb-cc06-46e3-9086-2c76aa323801', 0);
