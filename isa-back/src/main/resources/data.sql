...
-- questionnaire
insert into questionnaire (date, donation_number, rejected, healthy, dangerous_occupation, infectious, blood_pressure_issues, on_therapy, aspirin, tatooed) values ('2023-05-30', 1, false, true, false, false, false, false, false, false);
insert into questionnaire (date, donation_number, rejected, healthy, dangerous_occupation, infectious, blood_pressure_issues, on_therapy, aspirin, tatooed) values ('2023-05-30', 3, false, true, false, false, false, false, false, false);
insert into questionnaire (date, donation_number, rejected, healthy, dangerous_occupation, infectious, blood_pressure_issues, on_therapy, aspirin, tatooed) values ('2023-05-30', 7, false, true, true, false, false, false, false, false);
 
-- admin
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty, questionnaire_id) values ('application_user', 'ivan.m.sredojevic@gmail.com', 'admin', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'admin pass user', 'adminovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'medical center admin', 'admin at medical centers', true, 'ROLE_ADMIN', '99a3a2fb-cc06-46e3-9086-2c76aa323804', 0, null);
-- user

insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty, questionnaire_id) values ('application_user', 'ivan.sredojevic@devoteam.com', 'user', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'Ivan', 'Sredojevic', 'bul c laz 21', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'it consultant', 'senior consultant at dt srb', true, 'ROLE_USER', '99a3a2fb-cc06-46e3-9086-2c76aa323801', 0, 1);
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty, questionnaire_id) values ('application_user', 'ivansoko93@gmail.com', 'user12', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'user12 pass user', 'userovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'it consultant', 'junior consultant at dt srb', true, 'ROLE_USER', '99a3a2fb-cc06-46e3-9086-2c76aa323802', 2, 2);
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) values ('application_user', 'sokolicc.dji.acc@gmail.com', 'user11', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'user11 pass user', 'userovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'm', 'it consultant', 'junior consultant at dt srb', true, 'ROLE_USER', '99a3a2fb-cc06-46e3-9086-2c76aa323803', 3);

-- personnel
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty, center_id) values ('personnel', 'personnel_1@gmail.com', 'personnel_1', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'personnel_1 pass user', 'Personnelovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'f', 'medical technician', 'medical technician at kcv', true, 'ROLE_PERSONNEL', '99a3a2fb-cc06-46e3-9086-2c76aa323805', 0, 1);
insert into application_user (dtype, email, username, password, name, surname, address, city, state, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty, center_id) values ('personnel', 'personnel_2@gmail.com', 'personnel_2', '$10$t8s15mWHi5wBxl6jQ7rd3O86SrpDWKCECZGBEDixeKX9vmfsOku0e', 'personnel_2 pass user', 'Personnelovic', 'bul c laz 22', 'novi sad', 'serbia', '0640276707', '1012993773648', 'f', 'medical technician', 'medical technician at kamenica', true, 'ROLE_PERSONNEL', '99a3a2fb-cc06-46e3-9086-2c76aa323806', 0, 2);
