...
-- user
insert into application_user (dtype, email, username, password, name, surname, address, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) 
values ('application_user', 'ivan.sredojevicc@devoteam.com', 'user', '$2a$10$3TnwcRM8Es3lm3jQUClvK.wugatrVpe209UJ5xaKbec3EMAoaClve', 'Ivan', 'Sredojevic', 'bul c laz 21', '0640276707', '1012993773648', 'm', 'it consultant', 'senior consultant at dt srb', true, 'USER', '99a3a2fb-cc06-46e3-9086-2c76aa323801', 0);
insert into application_user (dtype, email, username, password, name, surname, address, phone, jmbg, sex, occupation, jobinformation, activated, role, token, penalty) 
values ('application_user', 'ivansoko93@gmail.com', 'user12', '$2a$10$3TnwcRM8Es3lm3jQUClvK.wugatrVpe209UJ5xaKbec3EMAoaClve', 'user12 pass user', 'userovic', 'bul c laz 22', '0640276707', '1012993773648', 'm', 'it consultant', 'junior consultant at dt srb', true, 'USER', '99a3a2fb-cc06-46e3-9086-2c76aa323802', 2);
...
-- free appointments
insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (1, null, '2023-06-06 09:00:00', '2023-06-06 09:00:00', 45, 60, false, false);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (1, null, '2023-06-06 10:00:00', '2023-06-06 10:00:00', 55, 40, false, false);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (2, null, '2023-06-06 12:00:00', '2023-06-06 12:00:00', 45, 38, false, false);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (2, null, '2023-06-06 11:00:00', '2023-06-06 11:00:00', 45, 42, false, false);

-- reserved appointments
insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (1, 2, '2023-06-08 11:00:00', '2023-06-08 11:00:00', 45, 49, false, true);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (1, 3, '2023-06-08 12:00:00', '2023-06-08 12:00:00', 45, 16, true, true);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (2, 3, '2023-06-08 11:00:00', '2023-06-08 11:00:00', 45, 82, false, true);

insert into appointment (center_id, application_user_id, modified_time, start_time, duration, price_euro, taken, approved) 
values (2, 2, '2023-06-08 12:00:00', '2023-06-08 12:00:00', 45, 53, true, true);
